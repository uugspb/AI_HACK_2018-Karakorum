...
namespace Karoku.Camera
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            var targetOrientation = Quaternion.Euler(transform.forward);
            ...
            if (vertical != 0f)
            {
                transform.Translate(transform.forward * flySpeed * vertical,
                    Space.World);
            }
            ...
            if (horizontal != 0f)
            {
                transform.Translate(transform.right * flySpeed * horizontal,
                    Space.World);
            }
